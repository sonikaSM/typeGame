//let temp=document.querySelector('time_l')
//const score=document.getElementById("score_l")
//const time=document.getElementById("time_l")
...
let words = document.querySelector(".word_l");
let timerDiv = document.querySelector(".time_l");
let scoreDiv = document.querySelector(".score_l");
let best_s=document.querySelector(".best_l")
let points = 0;
let spans;
let typed;
let seconds = 60;

let best_st=localStorage.getItem("best");
//if(best_st==null)best_st='0';
//sessionStorage.setItem("best",best_st);
...
function setBest(score){
    if(best_st!=null){
        if(score>
            best_st) localStorage.setItem("best", score);
    }
    else{
...
function countdown(button) {
    ...
    let timer = setInterval(function(){
        ...
        if (seconds === 0) {
            ...
            alert("Game over! Your score is " + points + "! The best score is: "+ best_st);
            //best_s.innerHTML=best;
...
function typing(e) {
    ...
    for (let j = 0; j < spans.length; j++) { //checking if all the letters are typed
        ...
        if (checker === spans.length) { // if so, animate the words with animate.css class
            ...
            setBest(points);
            best_s.innerHTML=best_st;
           // if(best_st!=null){best_s.innerHTML=best_st;}else{best_s.innerHTML="0";}
...
window.addEventListener('load',()=>{
    scoreDiv.innerHTML='0';
    if(best_st!=null){
        best_s.innerHTML=best_st.toString();
    }
